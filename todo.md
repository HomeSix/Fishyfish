...
diver (main character)
every game run start with the diver diving into water,
...
sea stuff can be interacted with, pops up the fish/stuff current state

then game play will be eg :- fish can be cleaned

if the sea stuff = trash, player can collect it and trash it somewhere?

// TOPICS BAHAN BUANGAN
1. jenis bahan buangan
 - ginja
 - plastik
 - sisa makanan
 - sisa toxic
...
2. bio degradable / non bio degradable
 # bio degradable
  - sisa makanan
  - kertas
  - ginja
...
2. Haiwan dan Tumbuhan yang diancam kepupusan
 - periuk kera
 - orkid selipar
 - pokok tongkat ali
...
3. Faktor menyebabkan haiwan dan tumbuhan diancam kepupusan
 - pemusnahan habitat
 - pemburuan haram
 - bencana alam
 - pencemaran
